...
// A fresh desktop starts in Simplified Chinese until persisted configuration
// is loaded. Keep translation fallback separate: partially translated locales
// still fall back to the complete English catalog instead of unexpectedly
// mixing Chinese into another selected language.
