...
export const en: Translations = {
  ...
  boot: {
    ready: 'Agent Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Agent settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Agent Desktop…'
    },
    errors: {
      backgroundExited: 'Agent background process exited.',
      backgroundExitedDuringStartup: 'Agent background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Agent backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Agent',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Agent Desktop.',
    ...
    native: {
      ...
      inputBody: 'Agent is waiting for your response.',
      turnDoneTitle: 'Agent finished',
      turnDoneBody: '',
  ...
  billingBlock: {
    titleNous: 'Out of model provider credits',
  ...
  titlebar: {
    ...
    hidePreview: 'Hide preview window',
    showPreview: 'Show preview window',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Agent defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Run in the Agent backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Agent backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Agent is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Agent asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Agent was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Agent was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Agent follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Agent can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Agent is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Agent, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Agent checks for updates automatically in the background and lets you know when one is ready.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Agent.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Agent backend elsewhere. Per-profile overrides below.',
      ...
      localDesc: 'Start a private Agent backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Agent backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Agent Cloud',
      cloudDesc: 'Sign in once to Agent Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Agent Cloud',
      cloudSignIn: 'Sign in to Agent Cloud',
      cloudSignedIn: 'Signed in to Agent Cloud',
      cloudNeedsSignIn: 'Sign in to Agent Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'model provider portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your Agent Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Agent Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Agent Cloud',
      cloudSignedOutMessage: 'Cleared the Agent Cloud session.',
      ...
      restartingMessage: 'Agent Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Agent ${version}` : ''}`,
      ...
      sshDesc:
        'Agent is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Agent path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Agent found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Agent runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Agent is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Agent path.',
      sshErrPlatform:
        'Unsupported remote platform. Agent Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Agent on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Agent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Agent at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a model provider subscription — sign in to model provider account to activate.',
      nousAuthNeededTitle: 'Sign in to model provider account',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to model provider account.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'model provider account connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'model provider account sign-in did not complete',
  ...
  starmap: {
    ...
    emptyDesc: 'As Agent builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Agent to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Agent to generate pets.',
      backgroundHint: 'You can close this — Agent will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Agent desktop' },
    ...
    hermesActiveSessions: (version, count) => `Agent ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Agent environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Agent will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Agent backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Agent. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Agent...',
    placeholderReconnecting: 'Reconnecting to Agent…',
    ...
    attachUrlDesc: 'Agent will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Agent to open PR',
      agentShipPrompt:
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Agent can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Agent is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Agent backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Agent from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Agent will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Agent desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Agent updater takes over in its own window and reopens Agent automatically when it’s done. Please don’t reopen Agent yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Agent reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Agent reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Agent needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Agent Desktop',
    setupChoiceDesc:
      'Connect this app to a Agent gateway you already run, or install Agent locally on this computer.',
    connectExistingTitle: 'Connect to existing Agent',
    ...
    installLocalTitle: 'Install Agent locally',
    installLocalDesc: 'Download Agent, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Agent Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Agent',
    remoteSetupDesc: 'Enter your gateway URL. Agent Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Agent gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Agent gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Agent CLI or desktop instance is running. Stop any running Agent instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Agent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Agent is finishing install. This usually takes under a minute on first run.',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Agent',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Agent at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Agent connects automatically',
    ...
    authorizeThere: 'Authorize Agent there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Agent there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid model provider subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Agent Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Agent Cloud · ${host}`,
  ...
  preview: {
    tab: 'Preview',
    dropToPreview: 'Drop files to open in preview',
    ...
    largeBody: (label, size) => `${label} is ${size}. Agent will only show the first 512 KB.`,
    ...
    web: {
      ...
      askRestart: 'Ask Agent to restart the server',
      lookingRestart: taskId => `Agent is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Agent is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Agent finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Agent could not restart the server.',
      stillWorking:
        'Agent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Agent is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Agent gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Agent won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Agent needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Agent needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Agent Desktop to use Save Image.',
    restartToSaveImages: 'Restart Agent Desktop to save images',
