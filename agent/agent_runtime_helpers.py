...
AGENT_RUNTIME_POST_HOOK_TOOL_NAMES = frozenset(
    {"todo", "session_search", "memory", "clarify", "read_terminal", "read_preview", "read_window_below", "delegate_task", "followup_task"}
)
...
def invoke_tool(agent, function_name: str, function_args: dict, effective_task_id: str,
    ...
    elif function_name == "followup_task":
        def _execute(next_args: dict) -> Any:
            return _finish_agent_tool(agent._dispatch_followup_task(next_args), next_args)
    else:
        def _execute(next_args: dict) -> Any:
