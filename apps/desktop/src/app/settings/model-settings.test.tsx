...
async function renderModelSettings(props: { onAddProvider?: () => void } = {}) {
...
describe('ModelSettings', () => {
  it('keeps provider management reachable from the model settings page', async () => {
    const onAddProvider = vi.fn()

    await renderModelSettings({ onAddProvider })
