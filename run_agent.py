...
class AIAgent:
    ...
    def _dispatch_followup_task(self, function_args: dict) -> str:
        """Continue a completed child using this agent as the durable owner."""
        from tools.delegate_tool import followup_task as _followup_task

        return _followup_task(
