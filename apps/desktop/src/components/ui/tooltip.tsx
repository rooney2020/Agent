  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        // One continuous card, even when a long model/path wraps. The previous
        // marker-style box-decoration-clone painted a separate dark slab for
        // every line and made wrapped tips look broken.
        className={cn(
          'pointer-events-none z-(--z-over-modal) w-fit max-w-80 select-none rounded-lg border border-border/70 bg-popover px-2.5 py-1.5 text-popover-foreground shadow-lg',
          className
        )}
        ...
        {...props}
      >
        <span className="block min-w-0 whitespace-normal break-words text-[11px] font-medium leading-[1.45] [overflow-wrap:anywhere] [&>*]:!inline-flex">
          {children}
        </span>
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
