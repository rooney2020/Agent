  ...
  return (
    <PopoverPrimitive.Portal container={container}>
      <PopoverPrimitive.Content
        ...
        className={cn(
          'z-50 w-72 origin-(--radix-popover-content-transform-origin) rounded-xl border border-(--ui-stroke-secondary) bg-[var(--popover-surface)] p-3 text-popover-foreground shadow-md backdrop-blur-xl outline-hidden data-[side=bottom]:slide-in-from-top-1 data-[side=left]:slide-in-from-right-1 data-[side=right]:slide-in-from-left-1 data-[side=top]:slide-in-from-bottom-1 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 [--popover-surface:color-mix(in_srgb,var(--ui-bg-elevated)_94%,transparent)]',
          className
        )}
