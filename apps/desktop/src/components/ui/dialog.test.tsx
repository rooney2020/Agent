...
describe('DialogContent close button', () => {
  ...
  it('keeps a stable hit target while pressed', () => {
    render(
      <Dialog open>
        <DialogContent>
          <DialogTitle>Test dialog</DialogTitle>
    ...
    expect(close.className).not.toContain('translate')
    expect(screen.getByRole('dialog').className).not.toContain('zoom-out')
  })
