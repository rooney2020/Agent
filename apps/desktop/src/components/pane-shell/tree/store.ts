...
/** Ephemeral whole-zone maximize state. Keeping this at the tree level makes
 * the tab strip and pane body one maximized surface while leaving native
 * window chrome accessible. */
export const $maximizedTreeGroupId = atom<string | null>(null)
