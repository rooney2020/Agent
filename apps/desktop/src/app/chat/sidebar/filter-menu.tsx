    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="min-w-52">
        <DropdownMenuGroup>
          ...
          <DropdownMenuSub>
            <DropdownMenuSubTrigger>显示范围</DropdownMenuSubTrigger>
            <DropdownMenuSubContent>
        ...
        <DropdownMenuGroup>
          ...
          <DropdownMenuSub>
            <DropdownMenuSubTrigger>配置档案</DropdownMenuSubTrigger>
          ...
          {projects.length > 1 && (
            <DropdownMenuSub>
              <DropdownMenuSubTrigger>项目</DropdownMenuSubTrigger>
              <DropdownMenuSubContent className="max-h-80 overflow-y-auto">
          ...
          {viewCustomized && <DropdownMenuItem onSelect={resetSidebarView}>恢复默认设置</DropdownMenuItem>}
        </DropdownMenuGroup>
