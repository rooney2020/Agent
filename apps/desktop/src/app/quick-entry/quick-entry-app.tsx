      ...
      >
        <div style={{ alignItems: 'center', display: 'flex', gap: 10 }}>
          ...
          <input
            ...
            placeholder={state.connected ? 'Ask Agent…' : 'Not connected — open Agent to reconnect'}
            ref={inputRef}
            spellCheck={false}
            style={{
              background: 'transparent',
        ...
        <div style={{ alignItems: 'center', display: 'flex', gap: 8 }}>
          ...
          <select
            ...
            value={state.target}
          >
            <option value={QUICK_TARGET_CURRENT}>当前对话</option>
            <option value={QUICK_TARGET_NEW}>新建会话</option>
