 ...
 *
 * The shipped default is Chromium actual size (100%). Fresh installs and
 * profiles recreated after user-data cleanup therefore start at true 1:1 UI
 * scale without depending on any persisted preference.
 */
